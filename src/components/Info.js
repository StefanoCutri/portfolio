...
export const Info = () => {
  return (
    <div className="flex flex-1 flex-col info-container" id="#home">
      <div className="flex flex-col justify-start items-start ml-[10%] mt-[25%] about-info">
        <h1>Hi, I'm</h1>
        ...
        <p className="w-[50%] text-[#8892b0]  mt-3">
          ...
          expanding my skills that you can see{" "}
          <a
            style={{
              position: "revert",
            }}
